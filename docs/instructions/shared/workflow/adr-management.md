...
3. **ステークホルダーレビュー**: 関係者による内容確認
4. **決定・承認**: ステータス「Accepted」に変更
5. **ファイル配置**: 正式なファイル名で配置・コミット
...
##### ステータス遷移ルール
- **Proposed → Accepted**: ステークホルダー承認により確定
...
2. **ピアレビュー**: 開発チーム内でのレビュー
3. **技術レビュー**: アーキテクト・テックリードによる技術妥当性確認
4. **最終承認**: 技術責任者による承認、ステータス「Accepted」
